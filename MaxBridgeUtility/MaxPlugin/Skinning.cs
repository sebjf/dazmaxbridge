...
namespace MaxManagedBridge
{
    public partial class MaxPlugin : MaxBridge
    {
        protected void UpdateMeshSkin(IINode mesh, MyMesh myMesh)
        {
            ...
            var skeleton_map = CreateSkeleton(myMesh);

            foreach (var bone in skeleton_map.Values)
            {
            ...
            List<vertexWeightMap> vertexWeights = GetWeightMapsByVertex(myMesh, skeleton_map);
