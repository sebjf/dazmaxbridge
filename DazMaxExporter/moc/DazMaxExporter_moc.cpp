...
**
** Created: Tue 20. Aug 23:11:01 2013
...
#error "The header file 'DazMaxExporter.h' doesn't include <QObject>."
...
static const uint qt_meta_data_MyDazUtility[] = {
...
static const char qt_meta_stringdata_MyDazUtility[] = {
    "MyDazUtility\0"
};

void MyDazUtility::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData MyDazUtility::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject MyDazUtility::staticMetaObject = {
    { &DzAction::staticMetaObject, qt_meta_stringdata_MyDazUtility,
      qt_meta_data_MyDazUtility, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &MyDazUtility::getStaticMetaObject() { return staticMetaObject; }
#endif //Q_NO_DATA_RELOCATION

const QMetaObject *MyDazUtility::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->metaObject : &staticMetaObject;
}

void *MyDazUtility::qt_metacast(const char *_clname)
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MyDazUtility))
        return static_cast<void*>(const_cast< MyDazUtility*>(this));
    return DzAction::qt_metacast(_clname);
}

int MyDazUtility::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
